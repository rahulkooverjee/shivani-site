    ...
    tagline: (
      <>
        ...
        <span className="block mt-2 text-sm md:text-lg opacity-80">
          Admitted to practice law in <span className="text-white font-bold">New York State</span> and before the <span className="text-white font-bold">U.S. Patent and Trademark Office</span>.
        </span>
      </>
    ),
